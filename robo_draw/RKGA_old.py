...
class TSP:
    ...
    def genetic_algo(self, test=False):
        ...
        r = max(int(0.03 * n), 1)  # Reproduction, no. of individuals cloned directly from prev population
        m = 0  # int(0.05*n)       # migration, no. of random init new individuals
        p = 0.05  # prevfit percentile
        ...
        while count < max(10, max_count + 5) and time.time() - start < 6:
